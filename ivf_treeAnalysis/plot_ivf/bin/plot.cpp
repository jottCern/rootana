...
int main(){
    shared_ptr<ProcessHistograms> ivf_processes(new ProcessHistogramsTFile("../rootfiles/ivf_hist_mcttbar_new_9_addhists_test.root", "ivf_processes"));
...
//     formatters.add<Ignore>("bcand2_mll/");
    ...
    Plotter p("pdf", {ivf_processes}, formatters);
