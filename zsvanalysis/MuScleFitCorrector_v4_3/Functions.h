...
inline std::unique_ptr<scaleFunctionBase<double * > > scaleFunctionService( const int identifier ){
  typedef std::unique_ptr<scaleFunctionBase<double * > > result_type;
  switch ( identifier ) {
  case ( 50 ): return result_type( new scaleFunction50<double * > ); break;
  default: throw std::runtime_error("scaleFunctionService error: wrong identifier");
  }
}


// Service to build the resolution functor corresponding to the passed identifier                                                                               
inline std::unique_ptr<resolutionFunctionBase<double * > > resolutionFunctionService( const int identifier ){
  typedef std::unique_ptr<resolutionFunctionBase<double * > > result_type;
  switch ( identifier ) {
  case ( 45 ): return result_type( new resolutionFunction45<double * > ); break;
  case ( 46 ): return result_type( new resolutionFunction46<double * > ); break;
  case ( 57 ): return result_type( new resolutionFunction57<double * > ); break;
  default: throw std::runtime_error("resolutionFunctServe error: wrong identifier");
  }
}
