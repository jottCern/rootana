...
namespace {
string outputdir = "eps/full_more_sel6_higher_mcbpt";
string inputdir = "../zsvanalysis/rootfiles/full_more_sel4/";
...
int main(){
    ...
    formatters.add<SetOption>
       ...
       ("dR_mc_reco_diff", "xtext", "#Delta R (B_{reco}, B_{true})")
       ("mcb_bcand_pt_ratio", "xtext", "(p_{T}(B_{true})-p_{T}(B_{reco}))/p_{T}(B_{true})")
       ("mcbs_control_pt", "xtext", "p_{T}(B_{true})")
       ("ptz", "xtext", "p_{T}(ll)")
       ;
    ...
    format_eff.add<RebinVariable> ("matched_bcands_pt", 52, pt_bins) ("mcbs_pt", 52, pt_bins) ("double_matchedb_lower_pt", 52, pt_bins) ("double_matchedb_higher_pt", 52, pt_bins) ("double_mcb_lower_pt", 52, pt_bins) ("double_mcb_higher_pt", 52, pt_bins);
    format_eff.add<SetOption> ("*", "title_ur", "19.7 fb^{-1}, #sqrt{s}=8TeV") ("matched_bcands_pt", "xtext", "p_{T}(Gen-B)") ("matched_bcands_eta", "xtext", "#eta(Gen-B)") ("double_matchedb_lower_pt", "xtext", "lower p_{T}(Gen-B)") ("double_matchedb_higher_pt", "xtext", "higher p_{T}(Gen-B)") ("double_matchedb_dPhi", "xtext", "#Delta #phi(Gen-(B,B))") ("double_matchedb_dR", "xtext", "#Delta R(Gen-(B,B))");
